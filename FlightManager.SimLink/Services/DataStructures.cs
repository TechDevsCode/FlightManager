...
namespace FlightManager
{
    ...
    public struct SimUpdate
    {
        ...
        [DataItem("BRAKE PARKING POSITION", "bool")]
        ...
        public bool overspeedlWarning;

        [DataItem("FUEL TOTAL QUANTITY", "gallons")]
        public double fuelQty;

        [DataItem("GPS APPROACH TIMEZONE DEVIATION", 64)]
        public string gpsApproachTimeDeviation;

        [DataItem("GENERAL ENG RPM")]
    ...
    public static class UCLBHelpers
    {
