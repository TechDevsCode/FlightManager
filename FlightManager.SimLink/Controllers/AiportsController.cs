...
namespace FlightManager.Controllers
{
    public class AiportsController : ControllerBase
    {
        ...
        {
            return aiportsService.Airports.FirstOrDefault(x => x.ICAO == ICAO.ToUpper());
        }
        ...
        {
            return aiportsService.AirportsInRangeOf(ICAO.ToUpper(), miles).OrderBy(x => x.DistanceFrom).ToList();
        }
    }
}
